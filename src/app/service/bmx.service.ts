...
//   saveOrUpdateBMXInfo(project, data) { }
  ...
  getBrandMatrixByProject(projectName: string) {
  ...
  getBrandMatrixByProjectAndUserAnswers(projectName: string, username:string) {
  ...
  getBrandMatrixByProjectAllUserAnswers(projectName:string) {
  ...
  saveOrUpdateBradnMatrixTemplate(bmxCompleteObject:string,projectName:string) {
  ...
  saveOrUpdateAnswers(bmxCompleteObject:object,projectName:string, username:string, status:string) {
    //debugger
    const payloadString = JSON.stringify({
      ProjectName: projectName,
      status: status,
  ...
  getBrandMatrixTemplateByName(templateName:string) {
    const payloadString = JSON.stringify({
  ...
  deleteBrandMatrixTemplateByName(templateName:string, username:string) {
    const payloadString = JSON.stringify({
      TemplateName: templateName,
      Username: username,
    })
  ...
  saveBrandMatrixTemplate(templateName: string, templateObj: string, username: string) {
    const payloadString = JSON.stringify({
      TemplateName: templateName,
      Username: username,
