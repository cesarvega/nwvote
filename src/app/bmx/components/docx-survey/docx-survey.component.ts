...
//   AlignmentType,
//   File,  BorderStyle,Footer, PageNumber, ShadingType, Tab, convertInchesToTwip
// } from "docx";
...
//   constructor(private _hotkeysService: HotkeysService,  private _BmxService: BmxService, private http: HttpClient) { }
//   ngOnInit(): any {
//     this.firstload = true;
//     this.user = [];
//     this.projectList = [];
