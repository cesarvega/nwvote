...
export class LogoHeaderComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.bmxItem.componentText = (localStorage.getItem('displayName')) != 'null' ? localStorage.getItem('displayName') : localStorage.getItem('projectId') != 'null' ? localStorage.getItem('projectId') : this.bmxItem.componentText;
